...
namespace Project_BackendApi.Migrations
{
    ...
    [Migration("20210610085944_Adminrole1")]
            ...
            modelBuilder.Entity("Project_BackendApi.Models.CustomerOrderDetailsModel", b =>
                {
                    ...
                    b.HasOne("Project_BackendApi.Models.OrderProductsModel", "OrderProductsModel")
                        .WithMany()
                    ...
                    b.Navigation("OrderProductsModel");
                });

            modelBuilder.Entity("Project_BackendApi.Models.OrderProductsModel", b =>
                {
                    b.HasOne("Project_BackendApi.Models.cartModel", "cartModels")
                        .WithMany("OrderProductsModel")
